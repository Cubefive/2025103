export default class TeamStorage {
  ...
  loadTeamDatabase() {
    ...
    try {
      ...
      const playerDatabase = this.storage?.playerStorage ? this.storage.getPlayerDatabase() : null;
      if (playerDatabase && Array.isArray(playerDatabase)) {
        ...
        console.warn('playerStorage not available, skipping teamDatabase sync');
      }
